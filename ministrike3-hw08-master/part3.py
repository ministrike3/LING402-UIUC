...
for line in stdin:
    ...
    for part in parts:
        ...
        # Otherwise, if the part ends with a closing paren
            ...
            if child_string:
                print(child_string + '\t'+parent_node.string)
                ...
                children_string=child_node.string
                ...
                while (len(children) and children[-1].level==child_node.level):
                    ...
                    children_string=previous_child_node.string+' '+children_string

                # Print an output line, using the format string "{}\t{}",
                #       where the first slot is the children_string
                #       and the second slot is the string of the parent_node
                print(children_string+'\t'+parent_node.string)
        ...
        # We should never reach this else clause
            ...
            raise RuntimeError("Reached a part of the code that should be unreachable")
